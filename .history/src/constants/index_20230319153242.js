...
const projects = [
  ...
  },
  {
    ...
    description:
      "Web application that enables users to 3D Feeling, using the NextJs and Framer Motion and fully responsive web applications",
    tags: [
      {
        name: "NextJs",
        color: "blue-text-gradient",
  ...
  },
  {
    ...
    image: gym,
    source_code_link: "https://github.com/TauqeerHusain/Gym-App",
  },
];
